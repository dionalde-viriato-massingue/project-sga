...
public class Docent extends JFrame implements ActionListener{
      JTextField t1;
    JPanel p1,p2,p3,p4;
    ImageIcon IMG0,IMG1,IMG2,IMG3,IMG4,IMG5,IMG6,IMG7,IMG8,IMG9;
    JLabel l1,l2,l3,l4,l5;
    JButton b1,b2,b3,b4,b5,b6,b7,cad,seach,vGeral;
    Color c1,c2;
    Font f;
    String cod, name;
    public Docent(String cod, String name){
        this.cod=cod;
        this.name=name;
    setLayout(null);
    setTitle("Image");
   ...
   // b1.setBackground(c1);
    ...
    cad= new JButton("Cadeiras que Leciona");
