...
public class Estudante extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,labNac,
            lCod,labCurso,labProv,labSexo,labEstado, labNecessidade;
    Font f;
    Color c1;
    JButton bCad,bCan, bVol;
    JTextField tNome,t2,tContact,tFacul,t5,tData;
  ...
  l9= new JLabel("Nascimento:");
    ...
    ImgCad = new ImageIcon(getClass().getResource("Cadastro.png"));
   ...
   bCan.addActionListener(this);
    ...
    IMG2 = new ImageIcon(getClass().getResource("x4.png"));
    l3 = new JLabel(IMG2);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       int contacto= Integer.parseInt(tContact.getText());
