...
public class VgeralD extends JFrame implements ActionListener{
      JTextField t1;
    ...
    JButton b1,b2,b3,b4,b5,b6,b7,matric,seach,vGeral,aprov,cad;
    Color c1,c2;
    Font f;
    String cod, name;
    public VgeralD(String cod, String name){
        this.cod=cod;
        this.name=name;
    setLayout(null);
    setTitle("Image");
    ...
    f= new Font("Arial",Font.BOLD,20);
     ...
     dados = new JLabel("Dados do Docente");
    ...
    nome=new JLabel("Nome:"); nomeS=new JLabel("Dionalde Viriato Massingue");
    ...
    curso=new JLabel("Cadeira(s) que Leciona:"); cursoS=new JLabel("POO2");
   ...
   // b1.setBackground(c1);
    ...
    vGeral.setBounds(200,100,157,50);
    ...
    cad= new JButton("Estudantes Inscrito");
    cad.setBounds(367,100,157,50);
    cad.setBackground(new Color(62,164,179));
    cad.setFocusPainted(false);
    cad.setBorderPainted(false);
